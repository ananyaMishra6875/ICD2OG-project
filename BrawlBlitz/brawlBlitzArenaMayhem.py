...
mainTheme = mixer.Sound("ssbMainMenu.mp3")
boxingTheme = mixer.Sound("boxingTheme.mp3")
coliseumTheme = mixer.Sound("coliseumTheme.mp3")
clickSFX = mixer.Sound("ssbClick.mp3")
startClickSFX = mixer.Sound("ssbStart.mp3")
mainTheme.set_volume(1)
boxingTheme.set_volume(1)
coliseumTheme.set_volume(1)
clickSFX.set_volume(1)
startClickSFX.set_volume(1)
bgmTheme = mainTheme
...
opacitySurface1 = pygame.Surface((WIDTH,HEIGHT),pygame.SRCALPHA) # https://youtu.be/8_HVdxBqJmE?feature=shared
opacitySurface2 = pygame.Surface((WIDTH,HEIGHT),pygame.SRCALPHA)
...
while True:
  ...
  # game screen -----------------------------------------------------------------------------------
    ...
    if ((hp1 <= 0) or (hp2 <= 0)):
      screen.blit(opacitySurface2,(0,0))
      pygame.draw.rect(opacitySurface2,GREY_LOW_OPACTITY,(65,185,670,230),fill)
    ...
    # countdown screen
    if countdown:
      screen.blit(opacitySurface1,(0,0))
      pygame.draw.rect(opacitySurface1,GREY_LOW_OPACTITY,(0,250,800,80),fill)
      opacitySurface1.blit(titleFont.render("game starts in "+str(countdownNum),True,LIGHT_YELLOW),(187,265))
      pygame.display.update()
      if countdownNum == 3:
        MOVE = 3000
